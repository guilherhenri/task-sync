...
import { OnEmailVerificationRequested } from './on-email-verification-requested'
...
describe('On Email Verification Requested', () => {
  beforeEach(() => {
    ...
    new OnEmailVerificationRequested(inMemoryAuthUserService, sut)
  })
